...
$password = $_POST['txtpassword'];
 ...
 $sql = "SELECT * FROM admin WHERE username='" .$username . "' and password = '". $password."'";
    ...
    $row  = mysqli_fetch_array($result);
     ...
     if(isset($result)==1 && isset($_SESSION["admin-username"])) {
    {       
...
<head>
  ...
  <title>Admin login|Web-Based Voting System</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="../images/logo.png" width="100" height="100"><span class="style1">  </span></b><span class="style1"></span></a>  </div>
  <!-- /.login-logo -->
  <div class="card">
...
<p class="mb-1">&nbsp;</p>
  ...
  <p>&nbsp;</p>
  <p>&nbsp;</p>
<p align="center"><?php  include('../footer.php');?></p></div>
<!-- /.login-box -->
